 ...
 */
@Embeddable
public class EvalbecadoPK implements Serializable {
    ...
    public EvalbecadoPK(Date fecha, String becadoci) {
        this.fecha = fecha;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EvalbecadoPK)) {
            return false;
        }
        EvalbecadoPK other = (EvalbecadoPK) object;
    ...
    public String toString() {
        return "entities.EvalbecadoPK[ fecha=" + fecha + ", becadoci=" + becadoci + " ]";
    }
