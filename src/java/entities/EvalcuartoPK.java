 ...
 */
@Embeddable
public class EvalcuartoPK implements Serializable {
    ...
    public EvalcuartoPK(Date fecha, String cuartoid, String pisoid, String edificioid) {
        this.fecha = fecha;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EvalcuartoPK)) {
            return false;
        }
        EvalcuartoPK other = (EvalcuartoPK) object;
    ...
    public String toString() {
        return "entities.EvalcuartoPK[ fecha=" + fecha + ", cuartoid=" + cuartoid + ", pisoid=" + pisoid + ", edificioid=" + edificioid + " ]";
    }
