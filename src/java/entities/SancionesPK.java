 ...
 */
@Embeddable
public class SancionesPK implements Serializable {
    ...
    public SancionesPK(Date fecha, String becadoci) {
        this.fecha = fecha;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SancionesPK)) {
            return false;
        }
        SancionesPK other = (SancionesPK) object;
    ...
    public String toString() {
        return "entities.SancionesPK[ fecha=" + fecha + ", becadoci=" + becadoci + " ]";
    }
